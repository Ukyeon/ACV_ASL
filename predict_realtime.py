    ...
    def main(self, filename, caption):
        ...
        while cap1.isOpened():
            ...
            if ret:
                ...
                # cv2.putText(imS, caption, (200, 270), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 0),
                #             2, cv2.LINE_4)
                cv2.putText(imS, caption, (180, 270), cv2.FONT_HERSHEY_SIMPLEX, 0.7, text_color, 2, cv2.LINE_4)
